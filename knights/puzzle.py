...
knowledge2 = And(
    gameknowledge,
    Implication(AKnight, And(AKnight, BKnight)),  # If A is a Knight, both are Knights
    Implication(AKnave, BKnight),  # If A is a Knave, different kinds so B is Knight
    Implication(BKnight, AKnave),  # If B is a knight, A is a Knave
    # If B is a knave both are the same kind
